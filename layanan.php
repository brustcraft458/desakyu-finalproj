...
<body>
    ...
    <main>
        <div class="row row-cols-1 row-cols-md-4 text-center mx-auto px-3 d-flex align-items-center" style="max-width: 75em;">
            <div class="col">
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3">
                        <h4 class="my-0 fw-normal">Tidak Tahu</h4>
                    </div>
                    <div class="card-body">
                        <i class="ri-file-unknow-line ri-7x"></i>
                        <button type="button" class="w-100 btn btn-lg btn-outline-primary">Ajukan</button>
                    </div>
                </div>
            </div>
